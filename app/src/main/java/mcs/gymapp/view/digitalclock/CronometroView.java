package mcs.gymapp.view.digitalclock;
...
import mcs.gymapp.view.digitalclock.font.DFont;
...
public class CronometroView extends View {
    ...
    /*mc-001*/
    //contdown
    private DCount count;
    private SimpleDateFormat mShortDateFormat;
    private BaseSwipeListViewListener callBack;
    ...
    public CronometroView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void countDown(int t, BaseSwipeListViewListener SwipeListener, int pos) {
        callBack = SwipeListener;
        position = pos;
        long i = t* 1000;
        count = new DCount(i,this);
    }

    public void closeView(){
        callBack.autoClose(position);
    }
    ...
    public class DCount extends CountDownTimer {
        private CronometroView cV;

        public DCount(long millisInFuture, CronometroView v) {
